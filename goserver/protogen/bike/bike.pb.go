...
type StationStatus struct {
	...
	ParkedBikeCnt string `protobuf:"bytes,3,opt,name=parked_bike_cnt,json=parkedBikeCnt,proto3" json:"parked_bike_cnt,omitempty"`
}
...
func (x *StationStatus) GetParkedBikeCnt() string {
	if x != nil {
...
var file_bike_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x0d, 0x70, 0x61, 0x72, 0x6b, 0x65, 0x64, 0x42, 0x69, 0x6b, 0x65, 0x43, 0x6e,
